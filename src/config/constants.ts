...
export const PRIMARY_AGENT_NAMES = ['super_plan', 'super_build'] as const;
...
export const SUPER_PLAN_DELEGATABLE = [
  'explorer',
  'librarian',
  'oracle',
] as const;

export const SUPER_BUILD_DELEGATABLE = [
  'explorer',
  'librarian',
  'oracle',
  'fixer',
...
export const SUBAGENT_DELEGATION_RULES: Record<AgentName, readonly string[]> = {
  ...
  super_plan: SUPER_PLAN_DELEGATABLE,
  super_build: SUPER_BUILD_DELEGATABLE,
  fixer: [],
  designer: [],
  explorer: [],
  librarian: [],
...
export const DEFAULT_MODELS: Record<AgentName, string | undefined> = {
  ...
  super_plan: undefined,
  super_build: undefined,
