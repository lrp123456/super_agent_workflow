...
export function loadPluginConfig(directory: string): PluginConfig {
  ...
  if (projectConfig) {
    config = {
      ...
      superPlan: deepMerge(config.superPlan, projectConfig.superPlan),
      superBuild: deepMerge(config.superBuild, projectConfig.superBuild),
      codemap: deepMerge(config.codemap, projectConfig.codemap),
      mcpFailover: deepMerge(config.mcpFailover, projectConfig.mcpFailover),
    };
  }
