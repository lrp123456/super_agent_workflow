...
export const CUSTOM_SKILLS: CustomSkill[] = [
  ...
  },
  {
    name: 'brainstorm',
    description:
      'Generate multiple candidate approaches with trade-off analysis for complex planning decisions',
    allowedAgents: ['super_plan'],
    sourcePath: 'src/skills/brainstorm',
  },
  {
    name: 'plannotator',
    description:
      'Visual plan review and editing — review, modify, and approve execution plans before build',
    allowedAgents: ['super_plan'],
    sourcePath: 'src/skills/plannotator',
  },
];
